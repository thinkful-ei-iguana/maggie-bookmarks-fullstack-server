...
describe('Bookmarks endpoints', function () {
  ...
  describe('Unauthorized requests', () => {
    ...
    it('responds with 401 unauthorized for GET /bookmarks/:id', () => {
      ...
      return supertest(app)
        .get(`/bookmarks/${makeBookmarksArray.id}`)
        .expect(401, { error: 'Unauthorized request' });
    });
    it('responds with 401 unauthorized for DELETE /bookmarks/:id', () => {
      return supertest(app)
        .delete(`/bookmarks/${makeBookmarksArray.id}`)
        .expect(401, { error: 'Unauthorized request' });
    });
  });
        ...
        it('removes XSS attack content', () => {
          return supertest(app)
            ...
            .expect(res => {
              ...
              expect(res.body.content).to.eql('Bad image <img src="https://url.to.file.which/does-not.exist" onerror="alert(document.cookie);">. But not <strong>all</strong> bad.');
            });
        });
      });
